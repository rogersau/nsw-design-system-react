...
export interface HeaderProps extends React.HTMLAttributes<HTMLElement> {
  /**
   * Main site title displayed in the header
   */
  siteTitle?: string;
  /**
   * Optional additional descriptor text shown below the title
   */
  siteDescriptor?: string;
  /**
   * URL/path to co-brand logo image file
   * If provided, displays logo instead of text title
   */
  logo?: string;
  /**
   * Link URL for the homepage or root (clicking logo/title navigates here)
   */
  headerUrl: string;
  /**
   * Whether to show responsive mobile menu button
   * @default true
   */
  mobile?: boolean;
  /**
   * Whether to show search bar menu
   * @default true
   */
  search?: boolean;
  /**
   * Event handler for header search form submission
   * Receives form submit event with searchInput field
   */
 ...
 * Includes NSW waratah logo, site branding, optional mobile menu, and optional search.
 * Initializes NSW Design System JavaScript for interactive search functionality.
 * 
 * Features:
 * - NSW Government waratah logo (SVG)
 * - Site title or custom co-brand logo
 * - Optional mobile menu toggle button
 * - Optional search with collapsible search area
 * - Responsive layout
 * - Accessibility compliant with ARIA labels and screen reader text
 * 
 * @example
 * ```tsx
 ...
 * />
 * 
 * // Simple header with custom logo
 * <Header 
 *   headerUrl="/"
      ...
      <>
        <header className="nsw-header" {...attributeOptions}>
          <div className="nsw-header__container">
              ...
              <div className="nsw-header__main">
                ...
                {logo ? (
                  ...
                  <div className="nsw-header__name">
                    ...
                    <div className="nsw-header__description">{siteDescriptor}</div>
                  </div>
                )}
              </div>
              {mobile && (
            ...
            {search && (
              <div id="header-search" className="nsw-header__search-area js-search-area" hidden>
